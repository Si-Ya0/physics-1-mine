...
struct Ball { // Ball structure
    ...
    Color baseColor; // Should Be (Red, Green, Blue, and Yellow)
    Color color;
    int mass; // 2, 2, 8, 8
    float mew; // Should be (0.1, 0.8, 0.1, and 0.8)
    int randomRadius = GetRandomValue(10, 40);
};
